...
export const linkedListReverse: NumsTopic<ListState> = {
  ...
  codeAlt: {
    ...
    python: {
      ...
      map: [1, 2, 3, 4, 5, 6, 7, 8, 0, 9, 0],
    },
  },
  mistakes: [
    "Overwriting curr.next before bookmarking it — the rest of the list becomes unreachable.",
    "Returning head instead of prev — head is the old head, now the tail.",
    "Getting the three assignments out of order; the invariant is save → flip → advance, always.",
  ],
  interview: [
    "\"Reverse a linked list\" — asked verbatim, iteratively and recursively.",
    "\"Reverse nodes in k-groups\" — this loop as a subroutine.",
    "\"Check if a linked list is a palindrome\" — reverse the second half, compare, restore.",
  ],
