...
export const avl: NumsTopic<TreeState> = {
  ...
  mistakes: [
    "Forgetting to update heights on the unwind — every balance factor after that is stale.",
    "Applying a single rotation to an LR/RL kink; the tree comes back still unbalanced.",
    "Not reassigning the rotation's return value to the parent (or root) — the rotated subtree detaches.",
  ],
  interview: [
    "\"Why does TreeMap guarantee O(log n)?\" — self-balancing BSTs are the answer.",
    "\"Insert these values into an AVL tree and show each rotation\" — a whiteboard staple.",
    "\"AVL vs red-black tree — when would you pick each?\"",
  ],
  legend: [
