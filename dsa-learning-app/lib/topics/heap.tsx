...
export const heap: NumsTopic<TreeState> = {
  ...
  mistakes: [
    "Mixing 0-indexed and 1-indexed child formulas (2i+1/2i+2 vs 2i/2i+1) — half the heap violates the property.",
    "Sifting down by comparing with only one child; you must swap with the *smaller* of the two.",
    "Popping the root without moving the last element up first, leaving a hole in the complete tree.",
  ],
  interview: [
    "\"K-th largest element in a stream\" — a size-k min-heap.",
    "\"Merge k sorted lists\" — a heap of list heads.",
    "\"Find the median from a data stream\" — two heaps balanced against each other.",
  ],
  legend: [
    ["--c-compare", "current"],
